...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, IN1_Pin|IN2_Pin|GPIO_PIN_5, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IN1_Pin IN2_Pin PA5 */
  GPIO_InitStruct.Pin = IN1_Pin|IN2_Pin|GPIO_PIN_5;
